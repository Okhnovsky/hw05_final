...
POST_ON_SEC = 3
TEST_POST_CNT = AMOUNT_POSTS + POST_ON_SEC
...
class PostPagesTest(TestCase):
    ...
    def test_index_page_show_correct_context(self):
        ...
        self.about_post(response.context['page_obj'][0])
    ...
    def test_detail_page_show_correct_context(self):
        ...
        self.about_post(response.context['post'])
